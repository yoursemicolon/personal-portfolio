...
$propic=md5($propic).time().$extension;
 ...
 $sql="update tblstudents set photo=:propic where id=:eid";
...
{               ?>
                                ...
                                <div class="form-group"><label for="company" class=" form-control-label">Profile Pic</label><img src="images/<?php echo $row->photo;?>" width="100" height="100" value="<?php  echo $row->Picture;?>"></div>
